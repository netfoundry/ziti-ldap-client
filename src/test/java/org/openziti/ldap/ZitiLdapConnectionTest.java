...
{
    private final static org.slf4j.Logger log = LoggerFactory.getLogger(ZitiLdapConnectionTest.class);
    ...
    public void listUsers() throws LdapException {
        ...
        searchResponse.getEntries().forEach(ldapEntry -> ldapEntry.getAttributes().forEach(ldapAttribute -> log.info("Attribute Name : {}  Attribute Value : {}",ldapAttribute.getName(),ldapAttribute.getStringValue())));
